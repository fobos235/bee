  ...
  <div class="row">
    <div class="col-8 text-center offset-md-2">
      ...
      <div class="mt-5">
        ...
        <a class="btn btn-success btn-lg" href="https://github.com/fobos235/bee"><i class="fab fa-github"></i> Github</a>
      </div>
      <div class="mt-5">
        <p class="text-muted">Desarrollado con <i class="fas fa-heart text-danger"></i> por <a href="https://github.com/fobos235/bee" class="text-white">Fobos</a>.</p>
      </div>
    </div>
  </div>
</div>
